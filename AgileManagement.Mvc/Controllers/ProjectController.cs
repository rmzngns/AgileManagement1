...
namespace AgileManagement.Mvc.Controllers
{
    public class ProjectController : AuthBaseController
    {
        ...
        private readonly IConributorProjectList _conributorProjectList;
    



        public ProjectController(AuthenticatedUser authenticatedUser, IProjectWithContributorsRequestService projectWithContributorsRequestService, IContributorProjectAccessApprovementService contributorProjectAccessApprovementService, IProjectRepository projectRepository, IConributorProjectList conributorProjectList) : base(authenticatedUser)
        {
            ...
            _conributorProjectList = conributorProjectList;
        }

        public IActionResult Home()
        {
            var response=_conributorProjectList.OnProcess(authUser.UserId);
